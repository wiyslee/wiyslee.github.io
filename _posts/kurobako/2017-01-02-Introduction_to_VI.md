...
which is the familiar Bayes’ rule for computing the posterior of the parameters given
the observations.
...
where all expectations are taken with respect to $$z$$. But we immediately note
